...
public class LoadView
{
	...
	{
		if(type == 1){
			System.out.println(LoadView.class.getResource("/informatique/view/"+name));
			root=FXMLLoader.load(LoadView.class.getResource("/informatique/view/"+name)); //load a simple view
